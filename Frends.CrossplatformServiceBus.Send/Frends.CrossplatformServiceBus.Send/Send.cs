...
namespace Frends.CrossplatformServiceBus.Send;

/// <summary>
/// Azure Service Bus task.
/// </summary>
public class CrossplatformServiceBus
{
    /// <summary>
    /// Send message to Azure Service Bus queue or topic.
    /// [Documentation](https://tasks.frends.com/tasks/frends-tasks/Frends.CrossplatformServiceBus.Send
    /// </summary>
