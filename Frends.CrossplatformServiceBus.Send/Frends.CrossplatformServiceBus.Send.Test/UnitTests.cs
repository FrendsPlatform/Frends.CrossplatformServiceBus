...
namespace Frends.CrossplatformServiceBus.Send.Test;
...
public class UnitTests
{
    ...
    public void Queue_CreateQueueOrTopicIfItDoesNotExist_False_NoExistsError_Test()
    {
        ...
        var ex = Assert.ThrowsExceptionAsync<MessagingEntityNotFoundException>(async () => await CrossplatformServiceBus.Send(input, options, default)).Result;
    ...
    public void Queue_CreateQueueOrTopicIfItDoesNotExist_True_NoAccess_Test()
    {
        ...
        var ex = Assert.ThrowsExceptionAsync<UnauthorizedException>(async () => await CrossplatformServiceBus.Send(input, options, default)).Result;
    ...
    public async Task Queue_CreateQueueOrTopicIfItDoesNotExist_True_Send_Test()
    {
        ...
        var result = await  CrossplatformServiceBus.Send(input, options, default);
